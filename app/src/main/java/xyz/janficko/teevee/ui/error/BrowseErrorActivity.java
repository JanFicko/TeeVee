 ...
 * the License.
 */
package xyz.janficko.teevee.ui.error;
...
public class BrowseErrorActivity extends Activity {
	...
	private void testError() {
		...
		getFragmentManager().beginTransaction().add(R.id.activity_main, mErrorFragment).commit();

		mSpinnerFragment = new SpinnerFragment();
		getFragmentManager().beginTransaction().add(R.id.activity_main, mSpinnerFragment).commit();
